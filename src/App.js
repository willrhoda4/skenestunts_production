...
//                                 // ^^^^Re-throw the error to allow further handling up the chain
...
//   // grabs instagram data and refreshes long-lived token.
...
//         .catch( error  =>    console.error("Error getting Instagram token:", error ) );
//     }
...
//           .then( res => {                                    // we won't display videos in the gallery, just photos.
...
//                                 return Axios.put(`${process.env.REACT_APP_API_URL}updateData`, reqBody);
//                               }
//                           })
